  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Implemented entire workflow automations for the merchandising and sales teams using intelligent systems}
      \resumeItemListEnd
...
\section{Technical Skills}
 ...
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Developer Tools}{: Git, Docker, Redis, PostMan, GitHub (Actions), LangFuse, GCP} \\ \vspace{2pt}
     \textbf{AI Tools}{: Cursor, Claude Code, Jules}
    }}
 \end{itemize}
